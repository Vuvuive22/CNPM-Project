...
public class PhiDichVuController {
    ...
    public void changeFeeOnAction(ActionEvent event) {
        ...
        boolean confirmed = ControllerUtil.showConfirmationDialog("Xác nhận thay đổi phí dịch vụ chung cư",
                "Bạn có chắc chắn muốn thay đổi phí dịch vụ chung cư không ?");
        if (confirmed) {
